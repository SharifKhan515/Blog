    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="row">
                        <form class="form-horizontal" method="POST" action="{{ url('/editPost',array($post->id)) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="text" class="form-control"  rows="6" name="post_body" required>
                                        {{ $post->post_body }}
                                </textarea>
                        ...
                        <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                                <label for="category_id" class="col-md-4 control-label">Body</label>
                        ...
                        <div class="form-group{{ $errors->has('post_image') ? ' has-error' : '' }}">
                                <label for="post_image" class="col-md-4 control-label"> Feature Photo</label>
